# * Chop off the front of a clip by a specified length
# * 
...
def FromVegas(pyVEGAS):
    ...
    dialog = StringDialog("Length to chop off start from selected Events","Length (00:00:00:00)",ChopDist.ToString())
